...
upgrades = [
    ...
    { nome: "Qtd. de Quiques",       nivel_global: "upg_quiques_nivel",     max_lvl: 6,  preco_base: 30, esc: 25 },
    { nome: "Boost Velocidade",      nivel_global: "upg_boost_nivel",       max_lvl: 4,  preco_base: 20, esc: 27 },
    { nome: "Força do Impulso",      nivel_global: "upg_impulso_nivel",     max_lvl: 4,  preco_base: 15, esc: 33 },
    { nome: "Impulso Inicial",       nivel_global: "upg_vel_inicial_nivel", max_lvl: 4,  preco_base: 25, esc: 33 }  
];
