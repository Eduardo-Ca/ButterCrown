...
upgrades = [
    ...
    { nome: "Limite de Velocidade",  nivel_global: "upg_limite_vel_nivel",  max_lvl: 6,  preco_base: 15, esc: 30 },
    { nome: "Impulso Inicial",       nivel_global: "upg_vel_inicial_nivel", max_lvl: 3,  preco_base: 25, esc: 35 }  
];
